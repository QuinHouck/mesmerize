...
interface ElementItem extends PackageItem {
...
const PeriodicTableMap: React.FC<PeriodicTableMapProps> = ({ selected, type }) => {
    function getStyle(num: number) {
        if (!selected) {
            return mapStyles.regular;
        }
        
        if (!Array.isArray(selected)) {
            const element = selected as ElementItem;
            if (element.atomic_number === num) {
                return mapStyles.selected;
            } else {
                return mapStyles.regular;
            }
        } else {
            const atomicNumbers = (selected as ElementItem[]).map((n) => n.atomic_number);
            if (atomicNumbers.includes(num)) {
                return mapStyles.selected;
            } else {
                return mapStyles.regular;
            }
    ...
    return (
        ...
        >
            <G stroke="#000" id="g260">
                <G id="NG">
                    <Path id="36" d="M645 145H675V175H645z" {...getStyle(36)} />
                    <Path id="54" d="M645 180H675V210H645z" {...getStyle(54)} />
                    <Path id="86" d="M645 215H675V245H645z" {...getStyle(86)} />
                    <Path id="10" d="M645 75H675V105H645z" {...getStyle(10)} />
                    <Path id="18" d="M645 110H675V140H645z" {...getStyle(18)} />
                    <Path id="2" d="M645 40H675V70H645z" {...getStyle(2)} />
                    <Path id="118" d="M645 250H675V280H645z" {...getStyle(118)} />
                </G>
                <G id="MOID">
                    <Path id="32" d="M505 145H535V175H505z" {...getStyle(32)} />
                    <Path id="33" d="M540 145H570V175H540z" {...getStyle(33)} />
                    <Path id="51" d="M540 180H570V210H540z" {...getStyle(51)} />
                    <Path id="52" d="M575 180H605V210H575z" {...getStyle(52)} />
                    <Path id="5" d="M470 75H500V105H470z" {...getStyle(5)} />
                    <Path id="14" d="M505 110H535V140H505z" {...getStyle(14)} />
                </G>
                <G id="PTM">
                    <Path id="31" d="M470 145H500V175H470z" {...getStyle(31)} />
                    <Path id="49" d="M470 180H500V210H470z" {...getStyle(49)} />
                    <Path id="81" d="M470 215H500V245H470z" {...getStyle(81)} />
                    <Path id="50" d="M505 180H535V210H505z" {...getStyle(50)} />
                    <Path id="82" d="M505 215H535V245H505z" {...getStyle(82)} />
                    <Path id="83" d="M540 215H570V245H540z" {...getStyle(83)} />
                    <Path id="84" d="M575 215H605V245H575z" {...getStyle(84)} />
                    <Path id="13" d="M470 110H500V140H470z" {...getStyle(13)} />
                    <Path id="113" d="M470 250H500V280H470z" {...getStyle(113)} />
                    <Path id="114" d="M505 250H535V280H505z" {...getStyle(114)} />
                    <Path id="115" d="M540 250H570V280H540z" {...getStyle(115)} />
                    <Path id="116" d="M575 250H605V280H575z" {...getStyle(116)} />
                </G>
                <G id="HAL">
                    <Path id="9" d="M610 75H640V105H610z" {...getStyle(9)} />
                    <Path id="17" d="M610 110H640V140H610z" {...getStyle(17)} />
                    <Path id="35" d="M610 145H640V175H610z" {...getStyle(35)} />
                    <Path id="53" d="M610 180H640V210H610z" {...getStyle(53)} />
                    <Path id="85" d="M610 215H640V245H610z" {...getStyle(85)} />
                    <Path id="117" d="M610 250H640V280H610z" {...getStyle(117)} />
                </G>
                <G id="AN">
                    <Path id="89" d="M120 330H150V360H120z" {...getStyle(89)} />
                    <Path id="90" d="M155 330H185V360H155z" {...getStyle(90)} />
                    <Path id="91" d="M190 330H220V360H190z" {...getStyle(91)} />
                    <Path id="92" d="M225 330H255V360H225z" {...getStyle(92)} />
                    <Path id="93" d="M260 330H290V360H260z" {...getStyle(93)} />
                    <Path id="94" d="M295 330H325V360H295z" {...getStyle(94)} />
                    <Path id="95" d="M330 330H360V360H330z" {...getStyle(95)} />
                    <Path id="96" d="M365 330H395V360H365z" {...getStyle(96)} />
                    <Path id="97" d="M400 330H430V360H400z" {...getStyle(97)} />
                    <Path id="98" d="M435 330H465V360H435z" {...getStyle(98)} />
                    <Path id="99" d="M470 330H500V360H470z" {...getStyle(99)} />
                    <Path id="100" d="M505 330H535V360H505z" {...getStyle(100)} />
                    <Path id="101" d="M540 330H570V360H540z" {...getStyle(101)} />
                    <Path id="102" d="M575 330H605V360H575z" {...getStyle(102)} />
                    <Path id="103" d="M120 250H150V280H120z" {...getStyle(103)} />
                </G>
                <G id="LN">
                    <Path id="57" d="M120 295H150V325H120z" {...getStyle(57)} />
                    <Path id="58" d="M155 295H185V325H155z" {...getStyle(58)} />
                    <Path id="59" d="M190 295H220V325H190z" {...getStyle(59)} />
                    <Path id="60" d="M225 295H255V325H225z" {...getStyle(60)} />
                    <Path id="61" d="M260 295H290V325H260z" {...getStyle(61)} />
                    <Path id="62" d="M295 295H325V325H295z" {...getStyle(62)} />
                    <Path id="63" d="M330 295H360V325H330z" {...getStyle(63)} />
                    <Path id="64" d="M365 295H395V325H365z" {...getStyle(64)} />
                    <Path id="65" d="M400 295H430V325H400z" {...getStyle(65)} />
                    <Path id="66" d="M435 295H465V325H435z" {...getStyle(66)} />
                    <Path id="67" d="M470 295H500V325H470z" {...getStyle(67)} />
                    <Path id="68" d="M505 295H535V325H505z" {...getStyle(68)} />
                    <Path id="69" d="M540 295H570V325H540z" {...getStyle(69)} />
                    <Path id="70" d="M575 295H605V325H575z" {...getStyle(70)} />
                    <Path id="71" d="M120 215H150V245H120z" {...getStyle(71)} />
                </G>
                <G id="TM">
                    <Path id="30" d="M435 145H465V175H435z" {...getStyle(30)} />
                    <Path id="48" d="M435 180H465V210H435z" {...getStyle(48)} />
                    <Path id="80" d="M435 215H465V245H435z" {...getStyle(80)} />
                    <Path id="112" d="M435 250H465V280H435z" {...getStyle(112)} />
                    <Path id="109" d="M330 250H360V280H330z" {...getStyle(109)} />
                    <Path id="110" d="M365 250H395V280H365z" {...getStyle(110)} />
                    <Path id="111" d="M400 250H430V280H400z" {...getStyle(111)} />
                    <Path id="21" d="M120 145H150V175H120z" {...getStyle(21)} />
                    <Path id="39" d="M120 180H150V210H120z" {...getStyle(39)} />
                    <Path id="22" d="M155 145H185V175H155z" {...getStyle(22)} />
                    <Path id="40" d="M155 180H185V210H155z" {...getStyle(40)} />
                    <Path id="72" d="M155 215H185V245H155z" {...getStyle(72)} />
                    <Path id="104" d="M155 250H185V280H155z" {...getStyle(104)} />
                    <Path id="23" d="M190 145H220V175H190z" {...getStyle(23)} />
                    <Path id="41" d="M190 180H220V210H190z" {...getStyle(41)} />
                    <Path id="73" d="M190 215H220V245H190z" {...getStyle(73)} />
                    <Path id="105" d="M190 250H220V280H190z" {...getStyle(105)} />
                    <Path id="24" d="M225 145H255V175H225z" {...getStyle(24)} />
                    <Path id="42" d="M225 180H255V210H225z" {...getStyle(42)} />
                    <Path id="74" d="M225 215H255V245H225z" {...getStyle(74)} />
                    <Path id="106" d="M225 250H255V280H225z" {...getStyle(106)} />
                    <Path id="25" d="M260 145H290V175H260z" {...getStyle(25)} />
                    <Path id="43" d="M260 180H290V210H260z" {...getStyle(43)} />
                    <Path id="75" d="M260 215H290V245H260z" {...getStyle(75)} />
                    <Path id="107" d="M260 250H290V280H260z" {...getStyle(107)} />
                    <Path id="26" d="M295 145H325V175H295z" {...getStyle(26)} />
                    <Path id="44" d="M295 180H325V210H295z" {...getStyle(44)} />
                    <Path id="76" d="M295 215H325V245H295z" {...getStyle(76)} />
                    <Path id="108" d="M295 250H325V280H295z" {...getStyle(108)} />
                    <Path id="27" d="M330 145H360V175H330z" {...getStyle(27)} />
                    <Path id="45" d="M330 180H360V210H330z" {...getStyle(45)} />
                    <Path id="77" d="M330 215H360V245H330z" {...getStyle(77)} />
                    <Path id="28" d="M365 145H395V175H365z" {...getStyle(28)} />
                    <Path id="46" d="M365 180H395V210H365z" {...getStyle(46)} />
                    <Path id="78" d="M365 215H395V245H365z" {...getStyle(78)} />
                    <Path id="29" d="M400 145H430V175H400z" {...getStyle(29)} />
                    <Path id="47" d="M400 180H430V210H400z" {...getStyle(47)} />
                    <Path id="79" d="M400 215H430V245H400z" {...getStyle(79)} />
                </G>
                <G id="AM">
                    <Path id="3" d="M40 75H70V105H40z" {...getStyle(3)} />
                    <Path id="11" d="M40 110H70V140H40z" {...getStyle(11)} />
                    <Path id="19" d="M40 145H70V175H40z" {...getStyle(19)} />
                    <Path id="37" d="M40 180H70V210H40z" {...getStyle(37)} />
                    <Path id="55" d="M40 215H70V245H40z" {...getStyle(55)} />
                    <Path id="87" d="M40 250H70V280H40z" {...getStyle(87)} />
                </G>
                <G id="AEM">
                    <Path id="4" d="M75 75H105V105H75z" {...getStyle(4)} />
                    <Path id="12" d="M75 110H105V140H75z" {...getStyle(12)} />
                    <Path id="20" d="M75 145H105V175H75z" {...getStyle(20)} />
                    <Path id="38" d="M75 180H105V210H75z" {...getStyle(38)} />
                    <Path id="56" d="M75 215H105V245H75z" {...getStyle(56)} />
                    <Path id="88" d="M75 250H105V280H75z" {...getStyle(88)} />
                </G>
                <G id="NM">
                    <Path id="1" d="M40 40H70V70H40z" {...getStyle(1)} />
                    <Path id="7" d="M540 75H570V105H540z" {...getStyle(7)} />
                    <Path id="8" d="M575 75H605V105H575z" {...getStyle(8)} />
                    <Path id="34" d="M575 145H605V175H575z" {...getStyle(34)} />
                    <Path id="6" d="M505 75H535V105H505z" {...getStyle(6)} />
                    <Path id="15" d="M540 110H570V140H540z" {...getStyle(15)} />
                    <Path id="16" d="M575 110H605V140H575z" {...getStyle(16)} />
                </G>
            </G>
...
export default PeriodicTableMap;
